...
///        throw new RequestProblemException("Device name is invalid!", 400);
///     }
///
...
public class RequestProblemException extends RuntimeException {
    ...
    public RequestProblemException(String message, int statusCode, String errorCode, Object details) {
    ...
    /// @param message the exception message
    /// @param statusCode the HTTP status code
    public RequestProblemException(String message, int statusCode) {
    ...
    public RequestProblemException(String message, int statusCode, String errorCode) {
    ...
    public RequestProblemException(String message, int statusCode, Object details) {
