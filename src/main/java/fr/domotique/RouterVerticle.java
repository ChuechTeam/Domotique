...
public class RouterVerticle extends VerticleBase {
    ...
    public Future<?> start() throws Exception {
        ...
        // Add an error handler that sends correct responses when we throw a RequestProblemException.
    ...
    private static void handleRequestProblems(RoutingContext ctx) {
        ...
        // Is this exception one of those special RequestProblemExceptions?
        if (ctx.failure() instanceof RequestProblemException pb) {
