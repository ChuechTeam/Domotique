...
INSERT INTO User (`id`, `email`, `emailConfirmationToken`, `emailConfirmed`, `passHash`, `firstName`, `lastName`, `gender`, `role`, `level`, `points`) VALUES
                                                                                                                                                           (1, 'jean.dupont@ehpad.fr', 1234567890123456, 1, '$pbkdf2$$zP3DwtYzvu0Kf+X2FQHptQ$WdxhcSVAbCVtEBvy+Q0uBNds31VXzoi70fjXZwB3sLPYGX4y8i18435bJm8YFdETC8Os2DtGovIKJKCK0Rb57A', 'Jean', 'Dupont', 0, 0, 0, 150), -- Fixed level from 1 to 0
                                                                                                                                                           ...
                                                                                                                                                           (6, 'isabelle.richard@ehpad.fr', 6789012345678901, 1, '$pbkdf2$$zP3DwtYzvu0Kf+X2FQHptQ$WdxhcSVAbCVtEBvy+Q0uBNds31VXzoi70fjXZwB3sLPYGX4y8i18435bJm8YFdETC8Os2DtGovIKJKCK0Rb57A', 'Isabelle', 'Richard', 1, 0, 0, 190), -- Fixed level from 1 to 0
                                                                                                                                                           ...
                                                                                                                                                           (8, 'monique.durand@ehpad.fr', 8901234567890123, 1, '$pbkdf2$$zP3DwtYzvu0Kf+X2FQHptQ$WdxhcSVAbCVtEBvy+Q0uBNds31VXzoi70fjXZwB3sLPYGX4y8i18435bJm8YFdETC8Os2DtGovIKJKCK0Rb57A', 'Monique', 'Durand', 1, 0, 1, 480), -- Fixed level from 2 to 1
...
-- Admins
                                                                                                                                                           ...
                                                                                                                                                           (21, 'technicien.support@ehpad.fr', 2223334445556667, 1, '$pbkdf2$$zP3DwtYzvu0Kf+X2FQHptQ$WdxhcSVAbCVtEBvy+Q0uBNds31VXzoi70fjXZwB3sLPYGX4y8i18435bJm8YFdETC8Os2DtGovIKJKCK0Rb57A', 'Technicien', 'Support', 0, 2, 3, 1500); -- Fixed level from 2 to 3
...
INSERT INTO InviteCode (`id`, `usagesLeft`, `role`, `creatorId`, `createdAt`) VALUES
                                                                                    ('AP1X86', 1, 1, 20, NOW() - INTERVAL 3 DAY), -- Invite code for one caregiver, created by Admin Boss
                                                                                    ('MWXX0L', 5, 0, 21, NOW() - INTERVAL 1 WEEK); -- Invite code for 5 residents, created by Tech Support
...
-- Fix the wrong powered values.
UPDATE Device d
SET powered = (SELECT IF(p.status = 'POWER_ON', TRUE, FALSE) FROM PowerLog p WHERE p.deviceId = d.id ORDER BY time DESC limit 1)
WHERE d.id <> 0;